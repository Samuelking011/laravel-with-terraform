...
#Elasticache subnet group containing all Fargate public subnets applied to our Redis cluster.
...
#Redis cluster specifying the Elasticache subnet group and the security group.
